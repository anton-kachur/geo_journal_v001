...
class ChangePageState extends State<ChangePage> {
  ...
  getDataFromBox(var box_name) async {
    var boxx = await Hive.openBox<SoilDescription>(box_name);
  ...
  @override
  Widget build(BuildContext context) {
    var box_data = getDataFromBox(widget.value);
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (snapshot.hasError)
              ...
              return Scaffold(
                  appBar: AppBar(
                    backgroundColor: Colors.brown,
                    title: Text('Настройки базы данных'),
                  ),
                  body: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
